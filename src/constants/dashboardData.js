export const NAVIGATION_ITEMS = [
  ...
  { id: "leads", label: "Leads & enquiries", path: "/leads", icon: "Users" },
  { id: "bookings", label: "Bookings", path: "/bookings", icon: "Calendar" },
  { id: "clients", label: "Clients", path: "/clients", icon: "UserCheck" },
  {
    id: "quotes",
  ...
  { id: "menu", label: "Menu & packages", path: "/menu", icon: "Package" },
